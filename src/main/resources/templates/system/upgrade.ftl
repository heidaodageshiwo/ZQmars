...
<head>
    ...
    <title> ${systemInfo.projectName } | 系统升级 </title>
...
<#include "../comm/sideMenu.ftl">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <#--<iframe id='i_iframe' name="n_iframe" frameborder="0"></iframe>-->
            <iframe src="${upgrade.serverUrl}"  frameborder="0" style="width: 100%; min-height: 800px" ></iframe>
        </section>
        <!-- /.content -->
    </div>
    <!-- /.content-wrapper -->
...
<script src="/js/page/upgrade.js"></script>
</body>
</html>
