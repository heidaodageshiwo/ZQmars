...
<div class="modal fade" id="create-imsiFollow-dlg">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form id="imsiFollow-task-form" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="imsiFollow-timeWindow-top" class="col-sm-2 control-label">伴随时间窗上限</label>
                                <div class="col-sm-10">
                                    <input type="text" name="topTime" class="form-control" id="imsiFollow-timeWindow-top" value ="5">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="imsiFollow-timeWindow-bottom" class="col-sm-2 control-label">伴随时间窗下限</label>
                                <div class="col-sm-10">
...
<script src="/js/page/imsifollow.js"></script>
</body>
</html>
