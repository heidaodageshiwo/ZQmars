    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/analysis/imsiFollow">IMSI伴随分析</a></li>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">目标IMSI</label>
                                            <div class="col-sm-8">
                                                <p class="form-control-static">${taskReport.targetIMSI}</p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <input type="hidden" name="taskId" id="imsiFollow-task-id" value="${taskReport.taskId?c}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <table id="imsifollow-reportData-table" class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th>IMSI</th>
                                    <th>可能性百分比</th>
...
<script src="/js/page/imsiFollowReport.js"></script>
</body>
</html>
