...
(function() {
    ...
    InfoBox.prototype.isOpen = function(){
        return this._isOpen;
    }
        ...
        _adjustPosition: function(poi){
            ...
            switch(this._opts.align){
                ...
                case INFOBOX_AT_BOTTOM:
                    ...
                    break;
                case INFOBOX_AT_RIGHT:
                    if(this._marker){
                        this._div.style.top = pixel.y  - this._boxHeight / 2 - this._opts.offset.height - icon.anchor.height + icon.infoWindowAnchor.height + this._marker.getOffset().height + "px";
                        this._div.style.left = pixel.x - icon.anchor.width + this._marker.getOffset().width + icon.infoWindowAnchor.width  + "px";
                    }else{
                        this._div.style.top = pixel.y - this._boxHeight / 2  - this._opts.offset.height + "px";
                        this._div.style.left =  pixel.x  + this._opts.offset.width  + "px";
                    }
                    break;
                case INFOBOX_AT_LEFT:
                    if(this._marker){
                        this._div.style.top = pixel.y  - this._boxHeight / 2 + this._opts.offset.height - icon.anchor.height + icon.infoWindowAnchor.height + this._marker.getOffset().height + "px";
                        this._div.style.left = pixel.x - icon.anchor.width + this._marker.getOffset().width + icon.infoWindowAnchor.width - this._boxWidth  + "px";
                    }else{
                        this._div.style.top = pixel.y - this._boxHeight / 2  + this._opts.offset.height + "px";
                        this._div.style.left = pixel.x - this._boxWidth + this._opts.offset.width  + "px";
                    }
                    break;
            }
