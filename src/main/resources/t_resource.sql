...
CREATE TABLE `t_resource` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='资源表';
...
INSERT INTO `t_resource` VALUES ('37', '1', null, '用户配置', '/user/specific', null, '38', null, null, null, null, null, null, null, '0');
