...
CREATE TABLE `t_oper_code` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=159 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作码表';
...
INSERT INTO `t_oper_code` VALUES ('120', 'com.iekun.ef.controller.LoggerController.logger', '日志操作', '系统日志');
INSERT INTO `t_oper_code` VALUES ('121', 'com.iekun.ef.controller.HomeController.home', '主页面', '系统日志');
INSERT INTO `t_oper_code` VALUES ('122', '00D5', '归属地名单下发', '设备操作日志');
INSERT INTO `t_oper_code` VALUES ('123', '00AF', '服务器校准时间下发', '设备操作日志');
INSERT INTO `t_oper_code` VALUES ('124', 'com.iekun.ef.controller.SystemController.upgrade', '系统升级', '系统日志');
INSERT INTO `t_oper_code` VALUES ('125', 'com.iekun.ef.controller.UtilController.getCityCodes', '获取城市编码', '系统日志');
INSERT INTO `t_oper_code` VALUES ('126', 'com.iekun.ef.controller.DeviceController.status', '设备状态获取', '设备管理日志');
INSERT INTO `t_oper_code` VALUES ('127', 'com.iekun.ef.controller.TargetAlarmController.homeOwnership', '归属地管理', '目标预警日志');
INSERT INTO `t_oper_code` VALUES ('128', 'com.iekun.ef.controller.TargetAlarmController.blacklist', '获取黑名单列表', '目标预警日志');
INSERT INTO `t_oper_code` VALUES ('129', 'com.iekun.ef.controller.UserController.logout', '登出', '用户登录登出日志');
INSERT INTO `t_oper_code` VALUES ('130', 'com.iekun.ef.controller.DeviceController.status', '获取设备状态', '设备管理日志');
INSERT INTO `t_oper_code` VALUES ('132', 'com.iekun.ef.controller.DeviceVersionController.library', '设备版本库', '设备管理日志');
INSERT INTO `t_oper_code` VALUES ('133', 'com.iekun.ef.controller.DeviceVersionController.manager', '设备管理', '设备管理日志');
INSERT INTO `t_oper_code` VALUES ('134', 'com.iekun.ef.controller.SystemController.databaseMaintenance', '数据库维护', '系统日志');
INSERT INTO `t_oper_code` VALUES ('135', 'com.iekun.ef.controller.DeviceOamController.oam', '操作维护页面', '设备管理日志');
INSERT INTO `t_oper_code` VALUES ('136', '00C0', '获取设备状态', '设备管理日志');
INSERT INTO `t_oper_code` VALUES ('137', 'com.iekun.ef.controller.DeviceLicenseController.index', '设备license', '设备管理日志');
INSERT INTO `t_oper_code` VALUES ('138', 'com.iekun.ef.controller.DeviceLicenseController.history', '设备license历史', '设备管理日志');
INSERT INTO `t_oper_code` VALUES ('139', 'com.iekun.ef.controller.SystemController.configuration', '系统配置', '系统日志');
INSERT INTO `t_oper_code` VALUES ('140', 'offline', '设备离线', '设备状态日志');
INSERT INTO `t_oper_code` VALUES ('141', 'online', '设备上线', '设备状态日志');
INSERT INTO `t_oper_code` VALUES ('142', 'Start_Normal', '正常启动', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('143', 'RebootMsg', '重启消息', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('144', 'UpgradeVersion_Success', '更新版本成功', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('145', 'UpgradeLicense_Success', '更新授权成功', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('146', 'Gps_NotSyn_30Min', 'GPS半小时未同步', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('147', 'Sniffer_NotSyn_1Min', 'Sniffer周期同步失败1Min', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('148', 'RecvFactoryConfig', '恢复出厂设置', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('149', 'NeedConfig9361', '需要慢配9361', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('150', 'Ftp_NotTrans_30Min', 'FTP传文件半小时未结束', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('151', 'eth1_link_down_m', '双载波网卡1异常', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('152', 'eth1_link_down_s', '单载波网卡1异常', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('153', 'eth0_link_down_m', '双载波网卡0异常', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('154', 'eth0_link_down_s', '单载波网卡0异常', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('155', 'out_of_descriptor', '网卡描述符异常', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('156', 'NoHeartBeat', '检测不到ARM心跳', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('157', 'Lmt_cmd_or_Web_reboot', 'WEB重启', '设备启动原因');
INSERT INTO `t_oper_code` VALUES ('158', '24_hours_periodic_reboot', '定时重启', '设备启动原因');
