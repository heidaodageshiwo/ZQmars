...
public class Md5
{
  ...
  private void md5Update(byte[] inbuf, int inputLen)
  {
    ...
    if ((this.count[0] += (inputLen << 3)) < (inputLen << 3)) {  /*Modified by JEFFMA, 20151217*/
/*        if (this.count[0] += (inputLen << 3) < inputLen << 3) {*/
    ...
    if (inputLen >= partLen)
    {
      ...
      for (i = partLen; i + 63 < inputLen; i += 64)   /*Modified by JEFFMA 20151217, remove int type declaration*/
